...
conn.once('open', function ()
{
    ...
    const category_max_votes=[{"cat":"development","max_vote":400},{"cat":"bug-hunting","max_vote":125},{"cat":"ideas","max_vote":100},{"cat":"translations","max_vote":150},{"cat":"others","max_vote":225}];
    var processed_posts=[];
    const query = {
        reviewed: true,
                                                                    ...
                                                                    Post
                                                                        ...
                                                                        .then(contributions => {
                                                                            ...
                                                                            if (post.json_metadata.type === 'video-tutorials') {
                                                                                vote = vote + 10;
                                                                                achievements.push('Nice video tutorial! I was too lazy to read anyways!');
                                                                            }
